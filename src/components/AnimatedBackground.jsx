  ...
  return (
    <>
      ...
      <div className="code-overlay">
        ...
        <div className="code-line">  name: 'Charishma Nadipalli',</div>
        <div className="code-line">  role: 'Full-Stack Developer',</div>
        <div className="code-line">  skills: ['React', 'Spring Boot', 'Node.js', 'AWS'],</div>
        <div className="code-line">  experience: '4+ years'</div>
